...
namespace Thuongne.Areas.Admin.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(Web1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Payments != null ? 
                          ...
                          Problem("Entity set 'Web1Context.Payments'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PayName,Description")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PayName,Description")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Web1Context.Payments'  is null.");
            }
            var payment = await _context.Payments.FindAsync(id);
            if (payment != null)
            {
